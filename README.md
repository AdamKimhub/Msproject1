...
1. Run `01_get_final_dataset.py` to clean the original data and exctract the required features for this project. Since this repo already has the final dataset folder, this step can be skipped. 
